...
public class Vehicle {
    ...
    private PositionResponse lastPosition;
...
//        boolean idEquals = (id == null && request.id() == null) || (id != null && id.equals(request.id()));
        ...
        return licensePlateEquals && modelVehicleEquals && brandVehicleEquals && yearEquals && colorEquals && fuelTypeEquals && statusEquals && trackerEquals && organizationEquals;
    }
